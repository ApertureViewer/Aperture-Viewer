...
void settings_setup_listeners()
{
    ...
    // <AP:WW> Ensure shader update on shadow resolution scale change for correct shadow rendering.
    // Revert to handleShadowsResized for RenderShadowResolutionScale.
